         ...
         //检查输入的规范性，第1层防护
           ...
           else
           {
               ...
               else
               {
                   ...
                   string sql_sc = "insert into lsxxb(bianma,bianma_liushui,xmmc,xmzrr,cjbm,kcmc,jneirong,lkjs,phone,file1,editor,steps,completed,beizhu) values(@bm1,@bianma_liushui1,@xmmc1,@xmzrr1,@cjbm1,@kcmc1,@jneirong1,@lkjs1,@phone1,@file11,@editor1,@steps1,@completed1,@beizhu1);insert into lsjdb(bianma,bianma_liushui,jneirong,lkjs,phone,jindu,time,editor,step,completed) values(@bm1,@bianma_liushui1,@jneirong1,@lkjs1,@phone1,@jindu1,@time1,@editor1,@step1,@completed1)";
